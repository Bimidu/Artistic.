...
export default function AuthModal({ isOpen, onClose }: AuthModalProps) {
  ...
  return (
    <div
      className="fixed inset-0 backdrop-blur-lg bg-gray-500/20 flex items-center justify-center z-50"
      onClick={onClose}>
          ...
          {mode !== 'forgot-password' && (
            <>
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white border border-primary-300 rounded-xl text-sm font-medium text-primary-900 hover:bg-primary-50 transition-all"
              >
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white text-primary-500">or</span>
                </div>
              </div>
            </>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {mode !== 'forgot-password' && (
              <div>
                ...
                />
                {mode === 'register' && (
                  <p className="mt-1 text-xs text-primary-500">Minimum 8 characters</p>
                )}
              </div>
            )}
            ...
            {mode === 'forgot-password' && (
              <>
                <div>
                  <label htmlFor="newPassword" className="block text-sm font-medium text-primary-700 mb-2">
                    New Password
                  </label>
                  <input
                    type="password"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-6 py-3 bg-primary-900 text-white rounded-xl text-sm font-medium hover:bg-primary-800 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
